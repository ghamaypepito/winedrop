		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<input type="number" name="fgf_rule[fgf_cart_subtotal_min_value]" min="0" value="<?php echo esc_attr( $rule_data[ 'fgf_cart_subtotal_min_value' ] ) ; ?>"/>
				</td>
				<td>
					<?php esc_html_e( 'Max' , 'free-gifts-for-woocommerce' ) ; ?>
					<input type="number" name="fgf_rule[fgf_cart_subtotal_max_value]" min="0" value="<?php echo esc_attr( $rule_data[ 'fgf_cart_subtotal_max_value' ] ) ; ?>"/>
				</td>
			</tr>
