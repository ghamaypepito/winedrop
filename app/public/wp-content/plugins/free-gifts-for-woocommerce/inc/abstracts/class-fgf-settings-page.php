...
if ( ! class_exists( 'FGF_Settings_Page' ) ) {
	...
	abstract class FGF_Settings_Page {
		...
		public function save() {
			...
			FGF_Settings::add_message( esc_html__( 'Your settings have been saved' , 'free-gifts-for-woocommerce' ) ) ;
		...
		public function reset() {
			...
			FGF_Settings::add_message( esc_html__( 'Your settings have been reset' , 'free-gifts-for-woocommerce' ) ) ;
